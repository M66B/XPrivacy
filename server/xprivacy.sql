...
--
-- Host: localhost
-- Generation Time: Aug 10, 2013 at 12:30 PM
...
CREATE TABLE IF NOT EXISTS `xprivacy` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `restriction` (`android_id`(40),`android_sdk`,`package_name`(80),`package_version`(40),`restriction`(40),`method`(40))
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=2137 ;
