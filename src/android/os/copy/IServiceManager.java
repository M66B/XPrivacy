 ...
 * 
 * An implementation of this interface is usually published as the global
 * context object, which can be retrieved via BinderNative.getContextObject().
 * An easy way to retrieve this is with the static method
