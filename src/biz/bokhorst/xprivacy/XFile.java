...
public class XFile extends XHook {
	...
	protected void before(MethodHookParam param) throws Throwable {
		...
		String isolated = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + ".xprivacy"
				+ File.separator + Binder.getCallingUid();

		if (path != null && path.startsWith(mPath) && !path.startsWith(isolated)) {
