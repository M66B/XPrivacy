...
public class Meta {
	public static List<Hook> get() {
		...
		listHook.add(new Hook("identification", "SERIAL", false, true, "", 10, null, null));
		...
		listHook.add(new Hook("internet", "inet", true, true, "INTERNET", 10, null, null));
		...
		listHook.add(new Hook("ipc", "android.accounts.IAccountManager", true, false, "", 1, "1.99.1", null));
		listHook.add(new Hook("ipc", "android.app.IActivityManager", true, false, "", 1, "1.99.1", null));
		listHook.add(new Hook("ipc", "android.content.IClipboard", true, false, "", 1, "1.99.1", null));
		listHook.add(new Hook("ipc", "android.net.IConnectivityManager", true, false, "", 1, "1.99.1", null));
		listHook.add(new Hook("ipc", "android.location.ILocationManager", true, false, "", 1, "1.99.1", null));
		listHook.add(new Hook("ipc", "com.android.internal.telephony.ITelephonyRegistry", true, false, "", 1, "1.99.1", null));
		listHook.add(new Hook("ipc", "android.content.pm.IPackageManager", true, false, "", 1, "1.99.1", null));
		listHook.add(new Hook("ipc", "com.android.internal.telephony.IPhoneSubInfo", true, false, "", 1, "1.99.1", null));
		listHook.add(new Hook("ipc", "android.view.IWindowManager", true, false, "", 1, "1.99.1", null));
		listHook.add(new Hook("ipc", "android.net.wifi.IWifiManager", true, false, "", 1, "1.99.1", null));
		...
		listHook.add(new Hook("storage", "media", true, true, "WRITE_MEDIA_STORAGE", 10, null, null));
		listHook.add(new Hook("storage", "sdcard", true, true, "READ_EXTERNAL_STORAGE,WRITE_EXTERNAL_STORAGE", 10, null, null));
