...
public class Meta {
	...
	public static List<Hook> get() {
		...
		mListHook.add(new Hook("media", "Camera.permission", "CAMERA", 1, "2.2.3", null).AOSP(19).dangerous().doNotify());
		mListHook.add(new Hook("media", "Record.Audio.permission", "RECORD_AUDIO", 3, "2.2.3", null).AOSP(19).dangerous().doNotify());
		mListHook.add(new Hook("media", "Record.Video.permission", "RECORD_VIDEO", 3, "2.2.3", null).AOSP(19).dangerous().doNotify());
