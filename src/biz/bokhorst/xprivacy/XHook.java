...
public abstract class XHook {
	...
	protected boolean isRestrictedExtra(int uid, String restrictionName, String methodName, String originalValue,
			String fakeValue) throws Throwable {
		return PrivacyManager.getRestrictionExtra(this, uid, restrictionName, methodName, null, originalValue,
				fakeValue, mSecret);
	}
